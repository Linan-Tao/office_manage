...
class EstatesControllerTest < ActionController::TestCase
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post :create, estate: { buy_date: @estate.buy_date, name: @estate.name, note: @estate.note, number: @estate.number, remain_value: @estate.remain_value, total: @estate.total }
    end
  ...
  test "should update estate" do
    patch :update, id: @estate, estate: { buy_date: @estate.buy_date, name: @estate.name, note: @estate.note, number: @estate.number, remain_value: @estate.remain_value, total: @estate.total }
    assert_redirected_to estate_path(assigns(:estate))
  end
