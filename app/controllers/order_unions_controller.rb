class OrderUnionsController < ApplicationController
  ...
  private
    ...
    def order_union_params
      params.require(:order_union).permit(:code, :agent_id, orders_attributes: [:id, :number, :product_id, :require_time, :order_type, :ply, :texture, :face, :color, :terminal, :file, :_destroy])
    end
end
